...
public class MiniMax implements Serializable{
	...
	int tiger_sFinalMoveToBePerformed[] = new int[8];
	int goat_sFinalMoveToBePerformed[] = new int [128];
	...
	private int analysis(Board b) {
		// TODO Auto-generated method stub
			...
			if(b.p[tigerPosition].right != null)
				if(b.p[tigerPosition].right.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].left != null)
				if(b.p[tigerPosition].left.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].top != null)
				if(b.p[tigerPosition].top.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].bottom != null)
				if(b.p[tigerPosition].bottom.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].left_top != null)
				if(b.p[tigerPosition].left_top.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].left_bottom != null)
				if(b.p[tigerPosition].left_bottom.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].right_top != null)
				if(b.p[tigerPosition].right_top.vacant == false)
					tempLossPoint++;
			if(b.p[tigerPosition].right_bottom != null)
				if(b.p[tigerPosition].right_bottom.vacant == false)
					tempLossPoint++;
			...
			if(b.isGoatWinner(b.p[tigerPosition]) == true)
...
//		else {
			...
			for(int i=0,j=0 ; i< b.totalNoOfGoatOnTheBoard ; i++){
				...
				if(b.p[goatPositions[i]].left_top != null){
					if(isThisMoveValidForGoat(Integer.parseInt(b.p[goatPositions[i]].point_name)
												,Integer.parseInt(b.p[goatPositions[i]].left_top.point_name),b)){
						
						generatedGoatMoves[j][0] = Integer.parseInt(b.p[goatPositions[i]].point_name);
						generatedGoatMoves[j][1] = Integer.parseInt(b.p[goatPositions[i]].left_top.point_name);
						
						j++;  
					}
				
				}
				if(b.p[goatPositions[i]].left_bottom != null){
					if(isThisMoveValidForGoat(Integer.parseInt(b.p[goatPositions[i]].point_name)
												,Integer.parseInt(b.p[goatPositions[i]].left_bottom.point_name),b)){
						
						generatedGoatMoves[j][0] = Integer.parseInt(b.p[goatPositions[i]].point_name);
						generatedGoatMoves[j][1] = Integer.parseInt(b.p[goatPositions[i]].left_bottom.point_name);
						
						j++;  
					}
				
				}
				if(b.p[goatPositions[i]].right_top != null){
					if(isThisMoveValidForGoat(Integer.parseInt(b.p[goatPositions[i]].point_name)
												,Integer.parseInt(b.p[goatPositions[i]].right_top.point_name),b)){
						
						generatedGoatMoves[j][0] = Integer.parseInt(b.p[goatPositions[i]].point_name);
						generatedGoatMoves[j][1] = Integer.parseInt(b.p[goatPositions[i]].right_top.point_name);
						
						j++;  
					}
				
				}
				if(b.p[goatPositions[i]].right_bottom != null){
					if(isThisMoveValidForGoat(Integer.parseInt(b.p[goatPositions[i]].point_name)
												,Integer.parseInt(b.p[goatPositions[i]].right_bottom.point_name),b)){
						
						generatedGoatMoves[j][0] = Integer.parseInt(b.p[goatPositions[i]].point_name);
						generatedGoatMoves[j][1] = Integer.parseInt(b.p[goatPositions[i]].right_bottom.point_name);
...
//	}
	...
	int[][] generateTigerMove(Board b){   // fn() tested
		...
		if(b.p[tigerPositions].left != null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].left.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].left.point_name);
		...
		if(b.p[tigerPositions].right != null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].right.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].right.point_name);
		...
		if(b.p[tigerPositions].top != null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].top.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].top.point_name);
		...
		if(b.p[tigerPositions].bottom!= null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].bottom.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].bottom.point_name);
		...
		if(b.p[tigerPositions].left_top!= null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].left_top.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].left_top.point_name);
		...
		if(b.p[tigerPositions].left_bottom!= null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].left_bottom.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].left_bottom.point_name);
		...
		if(b.p[tigerPositions].right_top!= null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].right_top.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].right_top.point_name);
		...
		if(b.p[tigerPositions].right_bottom!= null){
			if(isThisMoveValidForTiger(Integer.parseInt(b.p[tigerPositions].point_name)
										,Integer.parseInt(b.p[tigerPositions].right_bottom.point_name),b)){
				
				generatedTigerMoves[j][0] = Integer.parseInt(b.p[tigerPositions].point_name);
				generatedTigerMoves[j][1] = Integer.parseInt(b.p[tigerPositions].right_bottom.point_name);
...
//			  	}
			             ...
			             else if((b.p[origin].equals(b.p[destination].left_top)
			              		 && b.p[destination].right_bottom != null
			              		 &&b.p[destination].right_bottom.tiger==false
			            		 && b.p[destination].right_bottom.goat==false)){
			            	
			            
			            	 moveStatus=true;
			             }
			             else if((b.p[origin].equals(b.p[destination].left_bottom)
			              		 && b.p[destination].right_top != null
			              		 &&b.p[destination].right_top.tiger==false
			            		 && b.p[destination].right_top.goat==false)){
			            	
			            
			            	 moveStatus=true;
			             }
			             else if((b.p[origin].equals(b.p[destination].right_top)
			              		 && b.p[destination].left_bottom != null
			              		 &&b.p[destination].left_bottom.tiger==false
			            		 && b.p[destination].left_bottom.goat==false)){
			            	
			            
			            	 moveStatus=true;
			             }
			             else if((b.p[origin].equals(b.p[destination].right_bottom)
			              		 && b.p[destination].left_top != null
			              		 &&b.p[destination].left_top.tiger==false
			            		 && b.p[destination].left_top.goat==false)){
		...
		int Tiger = 18;
		   ...
		   for(int i=0; i<31 ;i++){	
			   ...
			   if(b.p[i].tiger==true){
			      ...
			      Tiger=Integer.parseInt(b.p[i].point_name);
			      break;		 
			   	}
